...
@section('content')
        ...
        <div id="bootcarousel" class="carousel inc-top-heading slide carousel-fade animate_text" data-ride="carousel">
            ...
            <div class="carousel-inner carousel-zoom">
                <div class="item active">
                    <div class="slider-thumb bg-cover" style="background-image: url({{asset('assets/img/banner/1.jpeg')}});"></div>
                    <div class="box-table">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            ...
                                            <h2 data-animation="animated fadeInDown"></h2>
                ...
                <div class="item">
                    <div class="slider-thumb bg-cover" style="background-image: url({{asset('assets/img/banner/2.jpeg')}});"></div>
                    <div class="box-table">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                ...
                <div class="item">
                    <div class="slider-thumb bg-cover" style="background-image: url({{asset('assets/img/banner/3.jpeg')}});"></div>
                    <div class="box-table">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
            ...
            <div class="row">
                <div class="about-items">
                    <div class="col-md-6 info">
                        ...
                        <div class="bottom">
                            <div class="video">
                                <a href="https://www.youtube.com/watch?v=NxHNxmJv2bQ" class="popup-youtube relative theme video-play-button item-center">
    ...
    <div class="chose-us-area item-half">
        <div class="container-full">
            <div class="row">
                <div class="col-md-6 thumb bg-cover" style="background-image: url({{asset('assets/img/banner/4.jpeg')}});"></div>
                <div class="col-md-6 info">
                    <div class="heading">
                        <h2>Why Chose us</h2>
                        <p>
            ...
            <div class="row">
                <div class="health-tips-items tips-carousel owl-carousel owl-theme">
                    ...
                    <div class="single-item">
                        <div class="col-md-5">
                            <div class="thumb">
                                <img src="{{ asset('assets/img/doctors/1.jpeg') }}" alt="">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="info">
                    ...
                    <div class="single-item">
                        <div class="col-md-5">
                            <div class="thumb">
                                <img src="{{ asset('assets/img/doctors/5.jpeg') }}" alt="">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="info">
                    ...
                    <div class="single-item">
                        <div class="col-md-5">
                            <div class="thumb">
                                <img src="{{ asset('assets/img/doctors/6.jpeg') }}" alt="">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="info">
            ...
            <div class="row">
                <div class="doctor-items text-center">
                    ...
                    <div class="col-md-4 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('assets/img/doctors/2.jpeg') }}" alt="Thumb">
                                <div class="overlay">
                    ...
                    <div class="col-md-4 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('assets/img/doctors/3.jpeg') }}" alt="Thumb">
                                <div class="overlay">
                                    <a href="#"><i class="fas fa-plus"></i></a>
                                </div>
                                <div class="social">
                    ...
                    <div class="col-md-4 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('assets/img/doctors/4.jpeg') }}" alt="Thumb">
                                <div class="overlay">
                                    <a href="#"><i class="fas fa-plus"></i></a>
                                </div>
                                <div class="social">
                ...
                <div class="col-md-12">
                    <div class="testimonial-items testimonial-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            ...
                            <div class="provider">
                                <div class="thumb">
                                    <img src="{{ asset('assets/img/team/6.jpeg') }}" alt="Thumb">
                                </div>
                                <div class="info">
                                    <h4>Angle Natasha</h4>
                        ...
                        <div class="item">
                            ...
                            <div class="provider">
                                <div class="thumb">
                                    <img src="{{ asset('assets/img/team/7.jpeg') }}" alt="Thumb">
                                </div>
                                <div class="info">
                                    <h4>John Abraham</h4>
                        ...
                        <div class="item">
                            ...
                            <div class="provider">
                                <div class="thumb">
                                    <img src="{{ asset('assets/img/team/8.jpeg') }}" alt="Thumb">
                                </div>
                                <div class="info">
                                    <h4>Kriti Sairi</h4>
                                    <h5>patient of <span>surgery</span></h5>
                ...
                <div class="blog-items">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('assets/img/blog/1.jpeg') }}" alt="Thumb">
                                    <div class="post-type">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('assets/img/blog/2.jpeg') }}" alt="Thumb">
                                    <div class="post-type">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="blog-single-right-sidebar.html">
                                    <img src="{{ asset('assets/img/blog/3.jpeg') }}" alt="Thumb">
                                    <div class="post-type">
    ...
    <!-- Start Newsletter
    ============================================= -->
    <div class="newsletter-area default-padding shadow dark bg-fixed text-center text-light" style="background-image: url({{asset('assets/img/banner/3.jpeg')}});">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
